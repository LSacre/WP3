...
\begin{figure}[H]
    ...
    \includesvg[width=1.3\textwidth, keepaspectratio]{root_weight_boxplot}
    }
...
\begin{figure}[H]
    ...
    \setlength{\abovecaptionskip}{-30pt} % Adjust only for this figure
    \makebox[\textwidth]{ % Keeps the figure centered within the text width
    \includesvg[width=1.3\textwidth, keepaspectratio]{root_length_boxplot}
    }
...
\begin{figure}[H]
    ...
    \setlength{\abovecaptionskip}{-30pt} % Adjust only for this figure
    \makebox[\textwidth]{ % Keeps the figure centered within the text width
        \includesvg[width=1.3\textwidth, keepaspectratio]{halo_assay_heatmap}
    }
